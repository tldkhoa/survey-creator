...
export var enStrings = {
  ...
  survey: {
    ...
    dropQuestion: "Kéo câu hỏi từ thanh công cụ vào đây.",
    addLogicItem: "Tạo quy tắc để tùy chỉnh khảo sát của bạn.",
    copy: "Sao chép",
    addToToolbox: "Thêm vào thanh công cụ",
...
editorLocalization.locales["vi"] = viStrings;
